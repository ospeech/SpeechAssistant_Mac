...
from Spark_service_api import get_answer
import logging
...
class Pipeline():
    ...
    def run(self):
        while True:
            ...
            logger.info('wakeup & listening for instruct...')
            play_wakeup()
            ...
            play_waiting()
            # response_text="60分的开始，好过100分的等待"
            ...
            self.nlp_service.get_tts_result(response_text, temp_response_audio_path)
